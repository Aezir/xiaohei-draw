...
//
// manifest.json exposes a single global entry (`xbdrawGenerateInterceptor`).
...
function ensureInstalled() {
    ...
    if (typeof globalThis.xbdrawGenerateInterceptor === 'function'
        && globalThis.xbdrawGenerateInterceptor._lwbDispatcher === true) {
        return;
    }
    ...
    globalThis.xbdrawGenerateInterceptor = entry;
}
...
export function unregisterGenerateInterceptor(id) {
    ...
    if (!handlers.size && globalThis.xbdrawGenerateInterceptor === installedEntry) {
        delete globalThis.xbdrawGenerateInterceptor;
        installedEntry = null;
    }
}
